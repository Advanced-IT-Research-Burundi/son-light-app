...
<div class="container">
    ...
    <h3 class="my-4">Créer un nouveau reçu</h3>
    ...
    <form action="{{ route('receipts.store', $cashRegisters) }}" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="justification" name="justification" required>
                <option value="with_proof">Avec preuve</option>
                <option value="without_proof">Sans preuve</option>
            </select>
        </div>
