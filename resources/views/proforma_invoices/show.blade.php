<!-- resources/views/proforma_invoices/show.blade.php -->
@extends('layouts.app')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <dl class="row">
                ...
                <dd class="col-sm-9">{{ $proforma_invoice->price_letter }}</dd>
            ...
            <table class="table table-striped mt-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('proforma_invoices.proforma_invoice_lists.edit', [$proforma_invoice, $detail]) }}" class="btn btn-sm btn-info">
